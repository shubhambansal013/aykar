/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 897ee656f95c99f955aec48da7dcf062)
// Runtime types generated with workerd@1.20260708.1 2026-07-14 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	WORKER_SELF_REFERENCE: Fetcher /* aykar-staging */ | Fetcher /* aykar */;
}
declare namespace Cloudflare {
	interface StagingEnv {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		WORKER_SELF_REFERENCE: Fetcher /* aykar-staging */;
	}
	interface ProdEnv {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		WORKER_SELF_REFERENCE: Fetcher /* aykar */;
	}
